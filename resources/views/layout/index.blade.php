...
<body>
                ...
                <ul class="slides">
                    ...
                    <li class="slide">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.8s">Lorem Ipsum is simply dummy text of the printing
                            ...
                            also the leap into
                            electronic typesetting</p>
                        <img src="{{ asset('template') }}/images/slideimg.png" width="317" height="256" class="wow fadeInRight"
    ...
    <div class="contactwrapper">
        <div id="contactus" class="container">
            ...
            <img src="{{ asset('template') }}/images/pop1.png" width="486" height="137" class="firstpop" alt="pop">
            <img src="{{ asset('template') }}/images/popup2.png" width="487" height="137" class="secondpop" alt="pop">
            <img src="{{ asset('template') }}/images/popup3.png" width="487" height="137" class="thirdpop" alt="pop">
            <img src="{{ asset('template') }}/images/popup4.png" width="487" height="137" class="fourthpop" alt="pop">
            <img src="{{ asset('template') }}/images/popup6.png" width="487" height="137" class="fifthpop" alt="pop">
            <img src="{{ asset('template') }}/images/popup7.png" width="487" height="137" class="sixthpop" alt="pop">
